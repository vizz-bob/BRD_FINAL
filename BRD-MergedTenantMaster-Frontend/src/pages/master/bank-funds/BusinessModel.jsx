      ...
      <div className="space-y-3">
        ...
        {filteredModels.map((model) => (
          ...
          >
            ...
            <div className="text-gray-500 md:col-span-2 text-xs truncate">{model.description || "—"}</div>

            <span
              className={`px-3 py-1 text-xs rounded-full justify-self-start w-fit ${
                model.status === "ACTIVE"
            ...
            <div className="flex justify-end gap-2 col-span-2 md:col-span-1">
              ...
              <IconButton color="red" onClick={() => handleDelete(model.id)}>
                <FiTrash2 />
              </IconButton>
            </div>
          </div>
